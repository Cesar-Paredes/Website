          ...
          <div class="col-lg-4 col-md-12 mb-4">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="https://www.ratehub.ca/mortgage-payment-calculator" class="btn btn-primary">Button</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="https://www.remax-quebec.com/fr/index.rmx" class="btn btn-primary">Button</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="https://wowa.ca/calculators/capital-gain-tax" class="btn btn-primary">Button</a>
              </div>
            </div>
          </div>
        </div>
